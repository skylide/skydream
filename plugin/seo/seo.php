...
function seoEndIcone(){
    ...
    if($gplus.$facebook.$twitter != ''){
        ...
        if($gplus != '') echo '<a target="_blank" href="'.$gplus.'"><i class="fab fa-google-plus-g"></i></a>';
        if($facebook != '') echo '<a target="_blank" href="'.$facebook.'"><i class="fab fa-facebook-f"></i></a>';
        if($twitter != '') echo '<a target="_blank" href="'.$twitter.'"><i class="fab fa-twitter"></i></a>';
        if($youtube != '') echo '<a target="_blank" href="'.$youtube.'"><i class="fab fa-youtube"></i></a>';
        echo '</div>';
    }
}
?>